export const menuData = [
    ...
    },
    {
        ...
        icon: '🍗',
        items: [
            { id: 'cr1', variant_id: '5262de55-d870-46c2-aad9-25a7a096d8a0', name: 'Crispy clásico', desc: 'Filete de pollo empanizado extracrocante + papas fritas y/o hilo + cremas', price: 12.00, badge: '🔥 Clásico Crispy' },
            { id: 'cr2', variant_id: '5262de55-d870-46c2-aad9-25a7a096d8a0', name: 'Crispy especial', desc: 'Filete de pollo crispy + jamón inglés + queso derretido + papas fritas', price: 13.00 },
            { id: 'cr3', variant_id: '5262de55-d870-46c2-aad9-25a7a096d8a0', name: 'Crispy royal', desc: 'Filete de pollo crispy + huevo montado + queso derretido + papas', price: 14.00, badge: 'Popular' },
            { id: 'cr4', variant_id: '5262de55-d870-46c2-aad9-25a7a096d8a0', name: 'Crispy super', desc: 'Filete crispy + huevo + queso + jamón inglés + papas crocantes', price: 15.00 },
            { id: 'cr5', variant_id: '5262de55-d870-46c2-aad9-25a7a096d8a0', name: 'Crispy club royal', desc: 'Filete crispy + queso + jamón + huevo + tocino ahumado crocante + papas', price: 16.00, badge: '⭐ Supremo' }
        ]
    },
    {
        id: 'chorizos',
        ...
        icon: '🌭',
        items: [
            { id: 'c1', variant_id: '8fdde459-5909-49a4-a2c9-eacbec3efa18', name: 'Chorizo clásico', desc: 'Chorizo precocido ahumado doradito + papas fritas y/o hilo + cremas', price: 11.00 },
            { id: 'c2', variant_id: '9be1375d-d1ca-4ada-ab6d-55218b8a792d', name: 'Chorizo especial', desc: 'Chorizo precocido + jamón inglés + queso derretido + papas fritas', price: 12.00 },
            { id: 'c3', variant_id: '93e6270e-8acc-49f9-8c0f-3fee2faa4c70', name: 'Chorizo royal', desc: 'Chorizo precocido + huevo montado + queso derretido + papas', price: 13.00, badge: '🔥 Clásico' },
            { id: 'c4', variant_id: 'c084ac1e-f45b-4c6d-8173-1527d39ca3f5', name: 'Chorizo super', desc: 'Chorizo precocido + huevo + queso + jamón inglés + papas', price: 14.00 },
            { id: 'c5', variant_id: '6059ac60-e268-4809-9060-4253c62c24db', name: 'Chorizo club royal', desc: 'Chorizo precocido + queso + jamón + huevo + tocino ahumado + papas', price: 15.00, badge: '⭐ El Más Completo' }
        ]
    },
    {
        id: 'salchipapa',
    ...
    },
    {
        ...
        items: [
            ...
            { id: 'p3', variant_id: '7ff8ac6a-2ae7-4989-8a6e-5e535ca1fcb8', name: 'Muzlo broaster', desc: 'Jugoso muzlo broaster dorado con receta de la casa + papas fritas + ensalada', price: 13.00 },
    ...
    {
        id: 'extras_porciones',
        name: 'Gaseosas y Extras',
        icon: '🥤',
        items: [
            { id: 'ex9', variant_id: '79e76f6e-a502-43c0-85a0-a2de773691f3', name: 'Inca Kola 500ml', desc: 'Gaseosa Inca Kola de medio litro bien helada', price: 3.80, badge: '🥤 Helada' },
            { id: 'ex10', variant_id: '79e76f6e-a502-43c0-85a0-a2de773691f3', name: 'Coca Cola 500ml', desc: 'Gaseosa Coca Cola de medio litro bien helada', price: 3.80, badge: '🥤 Helada' },
            ...
            { id: 'ex6', variant_id: '7ff8ac6a-2ae7-4989-8a6e-5e535ca1fcb8', name: 'Adicional de muzlo broaster', desc: 'Presa extra de muzlo broaster bien dorada', price: 8.00 },
            { id: 'ex7', variant_id: 'b34af2ce-02d8-426a-ab23-44a9c4b1f845', name: 'Adicional de carne', desc: 'Carne artesanal para hamburguesa a la plancha adicional', price: 6.00 },
            { id: 'ex8', variant_id: '8fdde459-5909-49a4-a2c9-eacbec3efa18', name: 'Adicional de chorizo', desc: 'Chorizo precocido a la plancha adicional', price: 6.00 },
            { id: 'ex11', variant_id: 'c577b91a-a10f-4e1e-9911-a1f73b9f6c97', name: 'Adicional de pollo', desc: 'Generosa porción de pollo deshilachado jugoso adicional', price: 6.00 }
        ]
    }
];
